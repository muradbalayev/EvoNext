      ...
      <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 gap-2">
        <button
          ...
          className={cn(
            ...
            "bg-background rounded-full border-2 border-border hover:bg-primary hover:text-primary-foreground",
        ...
        <button
          onClick={() => handleMove(1)}
          className={cn(
            "flex h-14 w-14 rounded-full items-center justify-center text-2xl transition-colors",
